package com.github.wikbake.springdemo.config;
...
@ComponentScan("com.github.wikbake.springdemo")
@PropertySource({ "classpath:persistence-mysql.properties", "classpath:security-persistence-mysql.properties" })
public class DemoAppConfig implements WebMvcConfigurer {

	/*
	 * It's helper class. Env will be loaded with properties file from the annotation 
	 * "classpath:persistence-mysql.properties". We use it in the class to read configs 
	 * for JDBC, Hibernate and connection pooling
	 */
	@Autowired
	 ...
	 * It's similar to stuff from XML file. 
	 */
	@Bean
	public DataSource myDataSource() {
		...
		// It's just to make sure we are reading the proper data
	...
	// This points to the security database for user id, passwords and roles.
	@Bean
	...
	// We need it because the app is going to use static web resources as CSS, images, js...
    @Override
